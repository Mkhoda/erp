const withPWA = require('next-pwa')({
  dest: 'public',
  // Completely disable PWA in development to avoid GenerateSW being called
  // multiple times and interfering with HMR / Fast Refresh.
  ...
  runtimeCaching: [
    ...
    },
    {
      urlPattern: ({ url }) => {
        ...
        // Exclude /api/auth and /api/webhook routes
